...
export function AuthShell({ subtitle, icon, children }) {
  return (
...
export function LoginPage({ onLogin, goRegister, goForgot }) {
...
export function ForgotPage({ goLogin }) {
...
export function ResetPage({ token, onDone }) {
